...
import com.maslobase.findteam.holders.ReceivedMessageHolder;
import com.maslobase.findteam.holders.SentMessageHolder;
...
public class ChatAdapter extends RecyclerView.Adapter {
    ...
    public int getItemViewType(int position) {
        ...
        if (message.getSender().equals(Utils.getCurrentUserSteamId())) {
